...
export const InformLeadModal = ({ isOpen, onClose }: InformLeadModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-120 bg-black/40 flex items-center justify-center p-4 backdrop-blur-sm animate-in fade-in duration-200 font-sans">
      <div className="bg-[#F8FAFC] w-full max-w-[700px] rounded-xl shadow-2xl flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
        
        {/* Header */}
        <div className="bg-white px-8 py-6 border-b border-gray-200 flex justify-between items-start shrink-0">
          <div>
            <span className="text-[#005EB8] text-[10px] font-bold uppercase tracking-wider mb-2 block">Draft Research Brief</span>
            <h2 className="text-[22px] font-bold text-gray-900 tracking-tight">Alternative medication for kidney sensitivity</h2>
          </div>
        ...
        <div className="p-8 overflow-y-auto flex-1 flex flex-col gap-8">
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
               ...
               <div className="bg-white border border-gray-200 rounded-lg p-5 shadow-sm">
                  <div className="flex justify-between items-start mb-3">
                     <span className="bg-[#EFF6FF] text-[#1D4ED8] text-[9px] font-bold px-2 py-1 rounded uppercase tracking-wider">Guideline</span>
                     <ExternalLink className="w-4 h-4 text-gray-400" />
                  </div>
                  <h4 className="font-bold text-gray-900 text-[15px] mb-2">NICE Guideline NG101</h4>
                  <p className="text-[13px] text-gray-500 leading-relaxed">Chronic kidney disease in adults: assessment and management.</p>
               </div>

               {/* Card 2 */}
               <div className="bg-white border border-gray-200 rounded-lg p-5 shadow-sm">
                  <div className="flex justify-between items-start mb-3">
                     <span className="bg-[#FEE2E2] text-[#B91C1C] text-[9px] font-bold px-2 py-1 rounded uppercase tracking-wider">PDF Snippet</span>
                     <FileText className="w-4 h-4 text-gray-400" />
                  </div>
                  <h4 className="font-bold text-gray-900 text-[15px] mb-2">CKD-Stage3-Dosing.pdf</h4>
                  <p className="text-[13px] text-gray-500 leading-relaxed">Annotated section on dosage adjustments for GFR &lt; 30.</p>
               </div>
            </div>

            <div className="flex items-center justify-between px-2 text-[12px] text-gray-500 font-medium">
          ...
          <section>
            ...
            <div className="relative">
               <textarea 
                 ...
                 className="w-full h-[120px] bg-white border border-gray-200 rounded-lg p-4 text-[15px] text-gray-800 outline-none resize-none focus:border-[#005EB8] transition-colors shadow-sm"
               />
               <div className="absolute bottom-3 right-4 flex items-center gap-1.5 text-[10px] font-bold text-gray-400 uppercase tracking-widest">
          ...
          <section className="bg-[#2A343F] rounded-lg p-5 shadow-md flex items-start gap-4">
             ...
             <div>
                <h4 className="text-white text-[11px] font-bold uppercase tracking-wider mb-2">AI Clinical Context</h4>
        ...
        <div className="bg-white border-t border-gray-200 p-6 flex items-center justify-between shrink-0">
           <div className="flex items-center gap-3">
              ...
              <div>
                 <span className="text-[9px] font-bold text-gray-400 uppercase tracking-widest block mb-0.5">Recipient</span>
                 <p className="text-[13px] font-bold text-gray-900">Dr. James Richardson (Lead)</p>
              </div>
           </div>
           
           <div className="flex items-center gap-6">
              <button className="text-[13px] font-bold text-gray-500 hover:text-gray-800 transition-colors uppercase tracking-wide">
                 Save as PDF
              </button>
              <button 
                onClick={onClose}
                className="bg-[#005EB8] hover:bg-[#004A99] text-white px-6 py-3 rounded-lg text-[13px] font-bold flex items-center gap-2 shadow-md transition-colors"
              >
