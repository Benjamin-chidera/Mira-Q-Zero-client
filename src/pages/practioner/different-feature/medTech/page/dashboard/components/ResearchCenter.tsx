    ...
    <div className="flex-1 flex flex-col gap-6 overflow-y-auto pr-2 pb-4">
       <div className="flex items-center justify-between pt-2">
          <div className="flex items-center gap-4">
             <h2 className="text-[22px] font-bold text-gray-900 tracking-tight">Research Center</h2>
             <span className="bg-[#F1F5F9] text-[#64748B] text-[11px] px-2.5 py-1 rounded font-bold tracking-wide">15 topics</span>
          </div>
          ...
          {[
            ...
            >
              <div className="flex justify-between items-start mb-3">
                 <span className="bg-[#EFF6FF] text-[#1D4ED8] text-[9px] font-bold px-2 py-1 rounded uppercase tracking-wider">{item.type}</span>
              ...
              <p className="text-[12px] text-gray-500 mb-4 line-clamp-2">Investigating the latest clinical trial outcomes and cross-referencing with regional health data...</p>
              <div className="flex items-center justify-between">
                 <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">{item.status}</span>
                 <span className="text-[11px] font-bold text-[#005EB8] group-hover:underline">View Details &rarr;</span>
              </div>
            </div>
          ))}
       </div>
