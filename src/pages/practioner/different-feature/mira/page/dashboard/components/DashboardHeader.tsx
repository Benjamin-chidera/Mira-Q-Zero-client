...
export function DashboardHeader({
  ...
  return (
    <header className="h-[70px] bg-white border-b border-gray-100 flex items-center justify-end px-8 shrink-0 relative z-30">
      <div className="relative">
        ...
        {showNotifications && (
           <div className="absolute right-0 mt-2 w-[380px] bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden z-50 flex flex-col">
              <div className="p-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                 <h3 className="font-bold text-gray-900 text-[14px]">Notifications</h3>
                 <span className="text-[10px] font-bold text-[#005EB8] bg-blue-50 px-2 py-1 rounded-full">3 new</span>
              </div>
                 ...
                 {[
                   ...
                   >
                      ...
                      <div className="flex-1">
                         <h4 className="font-bold text-gray-900 text-[13px]">{notif.title}</h4>
                         <p className="text-[12px] text-gray-500 mt-0.5 leading-snug">{notif.desc}</p>
           ...
           <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden border border-gray-100 flex flex-col">
              <div className="p-5 border-b border-gray-100 flex justify-between items-start bg-gray-50/50">
                 <div className="flex gap-4">
                    ...
                    <div>
                       <h3 className="font-bold text-gray-900 text-[16px] leading-tight">{selectedNotification.title}</h3>
                       <span className="text-[11px] font-bold text-gray-500">{selectedNotification.time}</span>
                    </div>
                 </div>
              ...
              <div className="p-6 flex flex-col gap-4">
                 <div className="bg-blue-50/50 border border-[#005EB8]/20 rounded-xl p-4">
                    <h4 className="text-[11px] font-bold text-[#005EB8] uppercase tracking-wider mb-2">Notification Summary</h4>
                    <p className="text-[13px] text-gray-800 font-medium leading-relaxed">{selectedNotification.desc}</p>
                 </div>
                 
                 <div>
                    <h4 className="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-2">Full Alert Details</h4>
                    <p className="text-[14px] text-gray-700 leading-relaxed bg-gray-50 p-4 rounded-xl border border-gray-100">
                       {selectedNotification.details}
                    </p>
                 </div>
              </div>
              <div className="p-5 border-t border-gray-100 flex justify-end bg-white">
                 <button onClick={() => setSelectedNotification(null)} className="bg-[#005EB8] text-white px-6 py-2.5 rounded-lg text-[13px] font-bold shadow-sm hover:bg-[#004A99] transition-colors">
                    Acknowledge
                 </button>
              </div>
           </div>
