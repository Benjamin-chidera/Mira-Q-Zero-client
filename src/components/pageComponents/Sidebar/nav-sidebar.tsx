...
const NAV_ITEMS: NavItem[] = [
  ...
  { icon: MessageSquare, label: "Messages", path: "/user/consultation" },
...
const NavSidebar = ({ activeItem = "consultation" }: NavSidebarProps) => {
  ...
  return (
    <aside className="w-48 border-r border-gray-200 bg-white flex flex-col h-full shrink-0">
      ...
      <div className="p-4 flex items-center gap-3">
        ...
        <div>
          <p className="text-sm font-semibold text-[#005EB8]">Patient Portal</p>
          <p className="text-xs text-gray-500">NHS ID: 832 921 002</p>
        </div>
      </div>
